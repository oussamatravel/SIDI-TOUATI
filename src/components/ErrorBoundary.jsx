...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ padding: '20px', backgroundColor: '#fee2e2', color: '#991b1b', margin: '20px', borderRadius: '8px', direction: 'ltr' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold' }}>A fatal error occurred!</h2>
